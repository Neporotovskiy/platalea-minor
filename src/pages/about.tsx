            ...
            <article className={styles.about}>
                ...
                <section className={styles.content}>
                    <Text as="p" color="light" size="medium">
                        ...
                        игровыми предпочтениями и стилем игры. Мы даём
                        возможность играть в дружеской атмосфере и получать
                        удовольствие от совместного прохождения сложных игровых
                        заданий. Мы приветствуем всех, кто ценит вдумчивый
                        геймплей и стремится играть в команде.
                    </Text>
                </section>
                <section className={styles.content}>
