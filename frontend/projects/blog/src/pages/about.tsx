        ...
        <article className={styles.about}>
            ...
            <section className={styles.content}>
                <Text as="p" color="light" size="small">
                    ...
                    игровыми предпочтениями и стилем игры, и дать им возможность
                    играть в дружественной атмосфере, получая удовольствие от
                    совместного прохождения сложных игровых заданий. Мы рады
                    всем, кто ценит вдумчивый геймплей и стремится играть в
                    команде.
                </Text>
                <Text
                    as="h2"
                ...
                <Text as="p" color="light" size="small">
                    ...
                    новинками жанра и держите в курсе новостей игровой
                    индустрии.
                </Text>
                <Text
                    as="h2"
                ...
                <Text as="p" color="light" size="small">
                    Мы строго следим за соблюдением норм поведения в сообществе
                    и стремимся поддерживать дружескую атмосферу. Вы будете
